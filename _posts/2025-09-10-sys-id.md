...
J\dot{\omega}&=\frac{\eta}{R_mK_v}\left(v_{in}-v_{emf}\right)-c\omega\\
J\dot{\omega}&=\frac{\eta}{R_mK_v}\left(v_{in}-\frac{\omega}{K_v}\right)-c\omega\\
J\dot{\omega}&=\frac{\eta}{R_mK_v}v_{in}-\left(c+\frac{\eta}{R_mK_v^2}\right)\omega
\end{aligned}
$$
