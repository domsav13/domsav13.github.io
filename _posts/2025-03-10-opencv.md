...
<div class="caption">
    The COCO dataset used here contains 91 everyday objects, but not all are detected with high confidence by the OpenCV model. The difficulty is reflected next to the confidence metric displayed with each bounding box
</div>
