...
tags: 
categories: 
thumbnail: assets/img/double-pend-thumbnail.jpg
related_posts: false
---
...
As illustrated below, the EKF simulation demonstrates stable and accurate estimation of the nonlinear dynamics when the system remains close to the linearization point. The estimator successfully reconstructs both measured and unmeasured angles with bounded estimation error and a decreasing covariance trace, however performance degrades as the system departs from the validity of the local Jacobians.
