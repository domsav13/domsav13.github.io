...
The dynamics of the system can be described by the following 2 equations of motion:
...
$$
K_1 = \begin{bmatrix}-5.11&-2.79&0.15&0.26\end{bmatrix} \quad \lambda(A-BK_1)=[-2\pm3i, -1\pm2i] \\
K_2 = \begin{bmatrix}-5.49&-1.60&8.27&2.95\end{bmatrix} \quad \lambda(A_BK_2) = [-2\pm3i, -3\pm4i]
$$
...
$$
F_k = \frac{\partial f}{\partial x}|_{\hat{x}_k,u_k} \quad\quad\quad H_k = \frac{\partial h}{\partial x}|_{\hat{x}_{k+1|k}
$$
...
$$
K_c = \alphaK \quad\quad\quad L_c = \betaL
$$
